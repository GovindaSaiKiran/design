...
export default function StartCampaignModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200 select-none">
      <div className="relative w-full max-w-lg bg-white rounded-2xl border-4 border-black shadow-[12px_12px_0px_#000000] p-6 sm:p-7 overflow-hidden">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-black/70">
                Automated AI voice dialing for students & applicants
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4 my-5 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-white border-2 border-black text-black font-bold shadow-[3px_3px_0px_#000000] focus:bg-[#fcffe0] focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-white border-2 border-black text-black font-bold shadow-[3px_3px_0px_#000000] focus:outline-none cursor-pointer"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-xl bg-white border-2 border-black text-black font-bold shadow-[2px_2px_0px_#000000] focus:outline-none cursor-pointer"
              >
          ...
          <div className="p-3.5 rounded-xl bg-[#fcffe0] border-2 border-black shadow-[3px_3px_0px_#000000] text-black flex items-center justify-between">
            <span className="font-bold flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-black stroke-[2.5]" />
              Smart Retry Logic (3 attempts if No Answer)
            </span>
            <span className="font-mono font-black text-xs bg-[#d6ff38] px-2 py-0.5 border border-black rounded">ENABLED</span>
          </div>
        </div>
